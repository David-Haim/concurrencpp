...
namespace concurrencpp::tests {
null_result initialy_resumed_null_result_coro(
...
void concurrencpp::tests::test_initialy_resumed_null_result_promise() {
  ...
  concurrencpp::details::wait_context wc;
  initialy_resumed_null_result_coro(wc, workers[0], workers[1], workers[2],
                                    workers[3], observer.get_testing_stub());
...
namespace concurrencpp::tests {
result<std::pair<int, std::string>> initialy_resumed_result_coro(
    worker_ptr w0,
    worker_ptr w1,
    worker_ptr w2,
    worker_ptr w3,
...
void concurrencpp::tests::test_initialy_resumed_result_promise() {
  ...
  object_observer observer;
  auto [i, s] = initialy_resumed_result_coro(workers[0], workers[1], workers[2],
                                             workers[3],
                                             observer.get_testing_stub(), false)
                    .get();
  ...
  auto result = initialy_resumed_result_coro(workers[0], workers[1], workers[2],
                                             workers[3],
                                             observer.get_testing_stub(), true);
...
namespace concurrencpp::tests {
null_result initialy_rescheduled_null_result_coro(
    executor_tag,
    worker_ptr w0,
...
void concurrencpp::tests::test_initialy_rescheduled_null_result_promise() {
  ...
  initialy_rescheduled_null_result_coro(
      {}, workers[0], std::this_thread::get_id(), wc, workers[1], workers[2],
      workers[3], observer.get_testing_stub());
...
namespace concurrencpp::tests {
result<std::pair<int, std::string>> initialy_rescheduled_result_coro(
    executor_tag,
    worker_ptr w0,
...
void concurrencpp::tests::test_initialy_rescheduled_result_promise() {
  ...
  auto [i, s] = initialy_rescheduled_result_coro(
                    {}, workers[0], std::this_thread::get_id(), workers[1],
                    workers[2], workers[3], observer.get_testing_stub(), false)
                    .get();
  ...
  auto result = initialy_rescheduled_result_coro(
      {}, workers[0], std::this_thread::get_id(), workers[1], workers[2],
      workers[3], observer.get_testing_stub(), true);
...
void concurrencpp::tests::test_coroutine_promises() {
  ...
  tester.add_step("initialy_resumed_null_result_promise",
                  test_initialy_resumed_null_result_promise);
  tester.add_step("initialy_resumed_result_promise",
                  test_initialy_resumed_result_promise);
  tester.add_step("initialy_rescheduled_null_result_promise",
                  test_initialy_rescheduled_null_result_promise);
  tester.add_step("initialy_rescheduled_result_promise",
