...
class testing_stub {
 ...
 public:
  ...
  testing_stub(std::shared_ptr<details::object_observer_state> state,
...
class value_testing_stub : public testing_stub {
 ...
 public:
  value_testing_stub(size_t return_value) noexcept :
      m_return_value(return_value) {}

  value_testing_stub(std::shared_ptr<details::object_observer_state> state,
                     const std::chrono::milliseconds dummy_work_time,
                     int return_value) noexcept :
      testing_stub(std::move(state), dummy_work_time),
      m_return_value(return_value) {}
...
class object_observer {
 ...
 public:
  ...
  testing_stub get_testing_stub(std::chrono::milliseconds dummy_work_time =
                                    std::chrono::milliseconds(0)) noexcept;
  value_testing_stub get_testing_stub(
      int value,
      std::chrono::milliseconds dummy_work_time =
          std::chrono::milliseconds(0)) noexcept;
  value_testing_stub get_testing_stub(
      size_t value,
      std::chrono::milliseconds dummy_work_time =
