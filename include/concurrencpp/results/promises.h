...
template<>
struct initial_scheduling_awaiter<concurrencpp::inline_executor> :
...
struct initialy_rescheduled_promise {
  ...
  static void* operator new(size_t size,
                            ...
                            argument_types&&... args) {
    return operator new (size, executor_tag {}, executor.get(),
  ...
  static void* operator new(size_t size,
    ...
    return operator new (size, executor_tag {}, std::addressof(executor),
                         std::forward<argument_types>(args)...);
  }
...
struct bulk_promise {
  ...
  static void* operator new(
    ...
    assert(coroutine_per_thread_data::s_tl_per_thread_data.accumulator ==
           nullptr);
...
struct result_publisher : public std::experimental::suspend_always {
  ...
  bool await_suspend(
      std::experimental::coroutine_handle<promise_type> handle) const noexcept {
...
template<class type>
struct result_coro_promise :
    public return_value_struct<result_coro_promise<type>, type> {
 ...
 public:
  ...
  ~result_coro_promise() noexcept {
    ...
    auto broken_task_error =
        std::make_exception_ptr(concurrencpp::errors::broken_task(
            "coroutine was destroyed before finishing execution"));
...
struct initialy_resumed_null_result_promise :
    public initialy_resumed_promise,
    public null_result_promise {};

template<class return_type>
struct initialy_resumed_result_promise :
    public initialy_resumed_promise,
...
struct bulk_null_result_promise :
    public bulk_promise,
    public null_result_promise {};

template<class return_type>
struct bulk_result_promise :
    public bulk_promise,
    public result_coro_promise<return_type> {};
}  // namespace concurrencpp::details
...
struct coroutine_traits<::concurrencpp::null_result, arguments...> {
  using promise_type =
      concurrencpp::details::initialy_resumed_null_result_promise;
};
...
struct coroutine_traits<::concurrencpp::result<type>, arguments...> {
  using promise_type =
      concurrencpp::details::initialy_resumed_result_promise<type>;
};
...
struct coroutine_traits<concurrencpp::null_result,
                        ...
                        std::shared_ptr<executor_type>,
                        arguments...> {
  using promise_type =
      concurrencpp::details::initialy_rescheduled_null_result_promise<
          executor_type>;
};
...
struct coroutine_traits<::concurrencpp::result<type>,
                        ...
                        arguments...> {
  using promise_type =
      concurrencpp::details::initialy_rescheduled_result_promise<type,
                                                                 executor_type>;
};
