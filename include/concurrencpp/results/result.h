...
namespace concurrencpp {
    ...
    class result {
        ...
        static_assert(valid_result_type_v, "concurrencpp::result<type> - <<type>> should be now-throw-move constructible or void.");
...
namespace concurrencpp {
    ...
    class result_promise {
        ...
        static_assert(valid_result_type_v,
                      "concurrencpp::result_promise<type> - <<type>> should be now-throw-move constructible or void.");
