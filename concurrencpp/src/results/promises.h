...
namespace concurrencpp::details {
	...
	struct initialy_resumed_null_result_promise :
		public initialy_resumed_promise, public null_result_promise {};

	template<class return_type>
	struct initialy_resumed_result_promise :
		public initialy_resumed_promise, public result_coro_promise<return_type> {};

	template<class executor_type>
	struct initialy_rescheduled_null_result_promise :
		public initialy_rescheduled_promise<executor_type>, public null_result_promise {};

	template<class return_type, class executor_type>
	struct initialy_rescheduled_result_promise :
		public initialy_rescheduled_promise<executor_type>, public result_coro_promise<return_type>{};
